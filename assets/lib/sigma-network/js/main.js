...
function resizeSigmaCanvas(renderer) {
    var ratio = window.devicePixelRatio || 1;
    var canvases = renderer._core.domElements;
    var container = renderer._core.domElements.container || renderer._core.domElements.nodes.parentNode;
    ...
    ['bg', 'bg2', 'nodes', 'edges', 'labels', 'hovers'].forEach(function(layer) {
        ...
        // CSS size follows container (so your CSS works)
        c.style.width  = w + "px";
        c.style.height = h + "px";
...
function nodeActive(a) {
    ...
    //hide main panel when attribute panel open
    $("#mainpanel").hide();
}
